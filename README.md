...
A listagem de pets é publica e não precisa de login.
Apenas cadastro de Pets por Organização

1:N
Uma ORG pra muitos pets

[] - Rota pra cadastrar um **ORGS** com os seguintes dados:
...
[] - Rota pra cadastrar um **PET** com os seguintes dados:
...
[] - Rota pra listar os **PETS**. Cidade como parâmetro obrigatório.
[] - Rota pra listar um **PET** específico.
